...
function AlertDialogOverlay({
  ...
  return (
    <AlertDialogPrimitive.Overlay
      ...
      // Tonal scrim, not glassmorphism: PRODUCT.md anti-references list
      // glassmorphic surfaces by name. Use `bg-foreground/40` so the scrim
  ...
  return (
    <AlertDialogPortal>
      ...
      <AlertDialogPrimitive.Content
        ...
        data-size={size}
        // Active-dialog elevation role per DESIGN.md: a moderate
        // `rounded-xl` (~11px) corner instead of pill-shaped `rounded-4xl`,
        // and the documented ambient `shadow-xl` only because this is the
        // one elevated-surface role the system permits.
        className={cn(
